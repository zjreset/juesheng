...
- (void)commonInit {
    ...
    _scrollView.backgroundColor = [UIColor clearColor]; //[UIColor colorWithPatternImage:TTIMAGE(@"bundle://middle_bk.jpg")];
...
- (void)configurePages {
    ...
    if (pageIndexChanged) {
        ...
        [_delegate currentPageDidChangeInPagingIndex:_currentPageIndex];
...
{
    NSLog(@"currentPageDidChangeInPagingIndex:%i",index);
}
#pragma mark -
#pragma mark init/dealloc
