    ...
    if (kind == UICollectionElementKindSectionFooter) {
        ...
        switch (self.filterType) {
            case QBImagePickerControllerFilterTypeNone:{
                ...
                NSString *str = NSLocalizedStringFromTableInBundle(format,@"QBImagePickerController",[NSBundle bundleWithPath:[[NSBundle mainBundle] pathForResource:@"QBImagePickerController" ofType:@"bundle"]],nil);
                if (str) {
                    footerView.textLabel.text = [NSString stringWithFormat:str,self.numberOfPhotos,self.numberOfVideos];
                }
                else{
                    footerView.textLabel.text = [NSString stringWithFormat:@"照片:%i,视频:%i",self.numberOfPhotos,self.numberOfVideos];
                }
                break;
            }
